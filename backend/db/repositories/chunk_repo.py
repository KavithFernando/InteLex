"""
Case chunks table: fetch by faiss_id, truncate, insert.
"""
...
def fetch_chunks_and_headers_by_faiss_ids(faiss_ids: List[int]) -> Dict[int, Dict[str, Any]]:
    """
...
def truncate_case_chunks(conn) -> None:
